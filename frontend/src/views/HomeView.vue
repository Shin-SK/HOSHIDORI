  ...
  <section class="top">
	...
	<div class="kv">
		<div class="kv__wrap">
			...
			<h1><a href="account_login">記憶を、記録する。</a></h1><!-- その場でふわっと -->
		</div>
	</div>
	...
	<div class="about container"><!-- 各ブロック下からふわっと -->
		<div class="about__wrap">
			<div class="box box1">
				<div class="img"><img src="/img/a-1.jpg" alt=""></div>
				<div class="text">
			...
			<div class="box rev box2">
				<div class="img"><img src="/img/a-2.jpg" alt=""></div>
				<div class="text">
			...
			<div class="box box3">
				<div class="img"><img src="/img/a-3.jpg" alt=""></div>
				<div class="text">
	...
	<div class="comment container">
		...
		<div class="img"><img src="/img/designer.jpg" alt=""></div>
    ...
    <router-link to="/login">記憶を、記録する。</router-link>
	</div>
